...
public class AppleTextToastView: UIView, ToastView {
    ...
    public func createView(for toast: Toast) {
        ...
        NSLayoutConstraint.activate([
            ...
            trailingAnchor.constraint(greaterThanOrEqualTo: superview.trailingAnchor, constant: -10),
